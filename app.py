...
app = Flask(__name__)
app.secret_key = "some.random.stuff.asdf"
...
def login():
  ...
  if form.validate_on_submit():
    try:
      ...
      flash("Your password or email doesn't match!", "error")
    else:
...
def unfollow(username):
  try:
    to_user = models.User.get(models.User.get(models.User.username**username))
  except models.DoesNotExist:
    pass
  else:
    try:
...
if __name__ == "__main__":
  ...
  try:
    models.User.create_user(
      username='samirpoonawala',
      email='samirpoonawala@gmail.com',
      password='password',
      admin=True    
  )
  except ValueError:
